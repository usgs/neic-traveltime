...
/**
 * Interpolate the model. This encapsulation is necessary because the Apache Commons library
 * routines don't handle the zero length intervals used in the Earth models to flag discontinuities
 * in velocity.
 *
 * @author Ray Buland
 */
public class ModelInterp {
   ...
   */
  public ModelInterp(ArrayList<ModelSample> model, ArrayList<ModelShell> shells, boolean isCubic) {
    this.model = model;
    this.shells = shells;
