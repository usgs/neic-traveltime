...
/**
 * Tne DecimateTravelTimeBranch class decimates the travel time branch in order to sample the Earth
 * and the ranges for both P and S waves adequately on one set of slownesses, the slowness sampling
 * will be very inhomogeneous. For any particular phase, this sampling translates to a ray parameter
