...
/**
 * Critical slowness value. The critical points are the beginnings and end of travel-time branches.
 * They correspond to velocities above and below discontinuities in the Earth model as well as
 * caustics.
 *
 * @author Ray Buland
 */
public class CritSlowness implements Comparable<CritSlowness> {
  ...
  public String toString() {
    return String.format("%c %-8s %8.6f %3d %3d", type, loc, slowness, pShell, sShell);
  }
}
