...
/**
 * One sample in the alternative view of the Earth model suitable for the tau-p travel-time
 * calculation.
 *
 * @author Ray Buland
 */
public class TauSample {
  ...
  /**
   * Initialize this sample. For some purposes, we don't need range.
   *
   * @param r Dimensional Earth radius in kilometers
   * @param slow Non-dimensional slowness
  ...
  /**
   * Get the depth index. This used to be a direct access file record number. Now it is used to
   * access the correct up-going tau and range for depth correction.
   *
