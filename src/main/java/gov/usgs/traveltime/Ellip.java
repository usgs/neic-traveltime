...
public class Ellip implements Serializable {
   ...
   */
  public double getEllipCorr(double sourceLat, double depth, double delta, double azim) {
    ...
    double tau0 = TauUtil.biLinear(delta, depth, delValue, depValue, t0);
    double tau1 = TauUtil.biLinear(delta, depth, delValue, depValue, t1);
    double tau2 = TauUtil.biLinear(delta, depth, delValue, depValue, t2);
