...
/**
 * Provides a programmatic way of getting information about diffracted and add-on phases.
 *
 * @author Ray Buland
 */
public class ExtraPhases {
  ...
  final String[] diffCode = {"P", "S", "pP", "sP", "pS", "sS", "PKPab", "pPKPab", "sPKPab"};
  final boolean[] diffUsed = {false, false, false, false, false, false, false, false, false};
  ...
  /**
   * Given a phase code, determine if the phase should be diffracted. Note that this determination
   * depends on the order that the phases are presented because there are multiple mantle P and S
   ...
   *
   * @return The maximum distance in radians that the diffracted phase can be observed.
   */
