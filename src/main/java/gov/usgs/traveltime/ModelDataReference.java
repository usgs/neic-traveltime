...
public class ModelDataReference implements Serializable {
  ...
  final ModelConversions cvt; // Model dependent conversions
   ...
   */
  public ModelDataReference(ReadTau in, ModelConversions cvt, char typeMod) {
   ...
   * @param typeMod Wave type ('P' or 'S')
   */
  public ModelDataReference(TauModel finModel, ModelConversions cvt, char typeMod) {
    int n, indexOffset;
    TauSample sample;
