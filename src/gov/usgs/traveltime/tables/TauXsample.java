...
/**
 * Tau and range integrals for all ray parameters from the surface to 
 * one source depth.
 * 
 * @author Ray Buland
 *
...
public class TauXsample {
	...
	/**
	 * Copy the partial tau and range integrals.  The shell names are only used 
	 * for the special cases of all integrals in the mantle, outer core, and 
	 * inner core.
	 * 
