...
public class TauUtil {
	...
	/**
	 * By default generate the model data from a model definition file.  
	 * This can be overridden (primarily for testing purposes) to read 
	 * from the input files generated by the old Fortran Remodl and 
	 * Setbrn programs.
	 */
